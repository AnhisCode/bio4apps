...
export default function List({ topics }: { topics: Topic[] }) {
  ...
  return (
    <div ref={listRef} className="flex w-full space-x-3 flex-col lg:flex-row h-full ">
      ...
      <ul className="h-64  flex flex-col justify-start lg:justify-center w-full text-left text-white list-disc list-inside marker:text-red-800/50 marker:text-4xl overflow-y-visible">
