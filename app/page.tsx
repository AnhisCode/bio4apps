    ...
    <main className="bg-white">
      <div className={'bg-hero-pattern bg-cover bg-no-repeat'}>
        <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center min-h-screen flex flex-col gap-y-4 items-center justify-center h-full font-infant uppercase">
          <h3 className="text-3xl font-jura font-extrabold text-gray-900 sm:text-4xl">2023</h3>
          <h1 className={`text-6xl font-extrabold text-gray-900 sm:text-8xl`}>BIO4APPS</h1>
          <p className="font-jura mt-4 text-lg text-gray-500">
            Bio4Apps 2023 is an international conference for researchers, scientists, and engineers throughout the world
            to present their latest findings, ideas, and applications in the areas of biosensors, bioelectronics,
            biomedical devices, and bioMES /NEMS.
          </p>
          <button
      ...
      <section className="pb-56  py-12 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center  flex flex-col gap-y-24 items-center justify-center h-full font-infant uppercase">
        <div>
